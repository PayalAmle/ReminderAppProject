...
public class Start_Page1 extends AppCompatActivity {
    private Button btn1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start__page1);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Start_Page1.this,"Wrong EmailID or Password!",Toast.LENGTH_LONG).show();
